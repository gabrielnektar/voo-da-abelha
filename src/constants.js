...
export const BEE_X = 100;
export const BEE_RADIUS = 14;
...
export const BARRIER_GAP_HEIGHT = 145;
export const BARRIER_GAP_HEIGHT_INITIAL = 205;
export const BARRIER_GAP_SHRINK_DURATION = 15;
export const BARRIER_GAP_MARGIN = 60;
export const BARRIER_SPACING = 260;
export const BARRIER_REACHABILITY_FACTOR = 0.75;

export const BONUS_BARRIER_INTERVAL = 3;
export const BONUS_GAP_HEIGHT = 135;
export const BONUS_GAP_MARGIN = 15;
export const BONUS_POLLEN_RADIUS = 10;
export const BONUS_POLLEN_POINTS = 100;
